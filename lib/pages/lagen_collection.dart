...
class Lagen_Collection extends StatefulWidget {
  @override
  State<Lagen_Collection> createState() => _Lagen_CollectionState();
}

class _Lagen_CollectionState extends State<Lagen_Collection> {
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Title_Area(fem: fem, ffem: ffem,title: 'STELLA VIVACITY',),
